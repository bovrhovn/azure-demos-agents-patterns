...
AnsiConsole.MarkupLine("[blue]Approval workflow with Agents programmatically[/]");
...
static string RunTests([Description("Name of the test suite to run")] string testSuite)
...
static string CheckStagingStatus()
...
static string DeployToProduction(
    [Description("The version to deploy")] string version,
    [Description("Comma-separated list of components to deploy")]
    string components)
...
static string CreateRollbackPlan([Description("The version being deployed")] string version)
    =>
